 ...
 */
final class Version20200220185829 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE topic ADD image_name VARCHAR(255) NOT NULL, ADD image_size INT NOT NULL, CHANGE id_user id_user INT DEFAULT NULL, CHANGE id_forum id_forum INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE topic DROP image_name, DROP image_size, CHANGE id_forum id_forum INT DEFAULT NULL, CHANGE id_user id_user INT DEFAULT NULL');
