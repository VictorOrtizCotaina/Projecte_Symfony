 ...
 */
final class Version20200219165149 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE id_user_group id_user_group INT DEFAULT NULL, CHANGE lang lang VARCHAR(30) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_general_ci`');
    }
}
